      ...
      <section className="relative bg-primary min-h-[500px] flex items-center">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20 text-white">
          <h1 className="text-4xl md:text-6xl font-bold mb-4 leading-tight">
            ...
            <span className="text-primary-light">ideal en Cochabamba</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-2xl">
            Casas, departamentos, terrenos y más. Te ayudamos a encontrar la propiedad perfecta para ti y tu familia.
          </p>
            ...
            {[
              {
                ...
                desc: "Todas nuestras propiedades son verificadas y cuentan con documentación legal al día.",
              },
              {
                icon: (
                  <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                desc: "Nuestro equipo te acompaña en todo el proceso, desde la búsqueda hasta la firma.",
              },
              {
                icon: (
                  <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                desc: "Propiedades en todas las zonas de Cochabamba y alrededores.",
              },
            ].map((item, i) => (
