  ...
  return (
    <>
      <div>
        {/* Main image */}
        <div
          className="relative w-full h-96 md:h-[500px] rounded-xl overflow-hidden mb-3 cursor-pointer"
        ...
        >
          ...
          <div className="absolute bottom-3 right-3 flex items-center gap-2">
            ...
            <button
              ...
              className="bg-black/60 hover:bg-black/80 text-white p-1.5 rounded-full transition"
              ...
              {images.map((img, i) => (
                <button
                  ...
                  className={`relative flex-shrink-0 w-14 h-14 rounded-lg overflow-hidden border-2 transition ${
                    i === current ? "border-white" : "border-transparent opacity-50 hover:opacity-100"
                  }`}
                >
